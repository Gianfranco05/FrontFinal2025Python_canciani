...
import { ShoppingBag, ArrowRight, Star, TrendingUp, ShieldCheck, Zap, Globe, Heart } from 'lucide-react';
...
export function Home() {
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 overflow-x-hidden selection:bg-indigo-100 selection:text-indigo-700">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-80px)] pt-10 pb-20">
                ...
                <div className="lg:w-1/2 text-center lg:text-left space-y-8">
                    ...
                    <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                        Descubre productos increíbles a precios inmejorables. Desde electrónica de vanguardia hasta moda de tendencia, definimos calidad y estilo.
                    </p>
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        ...
                        <button
                            ...
                            className="px-8 py-4 text-lg font-medium text-indigo-700 bg-white border border-indigo-100 rounded-full hover:bg-indigo-50 hover:shadow-md transition-all duration-300"
                        >
                            Aprender Mas
                        </button>
                    </div>
            ...
            {/* Nueva Sección de Beneficios (donde scrollea el botón) */}
            <div ref={infoSectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-gray-100">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-sm font-bold text-indigo-600 uppercase tracking-[0.2em]">¿Por qué elegirnos?</h2>
                    <p className="text-4xl font-black text-gray-900">Elevamos tu experiencia de compra</p>
                    <div className="w-24 h-1.5 bg-gradient-to-r from-indigo-600 to-purple-600 mx-auto rounded-full"></div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="group bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Envío Ultra Rápido</h3>
                        <p className="text-gray-500 leading-relaxed">
                            Logística de vanguardia para que tus productos lleguen de manera segura y en tiempo récord a la puerta de tu casa.
                        </p>
                    </div>
                    ...
                    <div className="group bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Alcance Global</h3>
                        <p className="text-gray-500 leading-relaxed">
                            Traemos las mejores marcas del mundo directamente a tu pantalla. Variedad sin fronteras y calidad garantizada.
                        </p>
                    </div>
                    ...
                    <div className="group bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Soporte Dedicado</h3>
                        <p className="text-gray-500 leading-relaxed">
                            Nuestro equipo está siempre disponible para ayudarte. Tu satisfacción es nuestra prioridad absoluta.
                        </p>
                    </div>
                </div>
            </div>
